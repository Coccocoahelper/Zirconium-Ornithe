...
public class FontStrategist {
    ...
    /*public static boolean isSplashTextRendererActive(TextRenderer TextRenderer) {
        ...
        boolean active = TextRenderer instanceof SplashProgress.SplashTextRenderer;

        try {
            Class<?> customSplashClass = Class.forName("gkappa.modernsplash.CustomSplash$SplashTextRenderer");
            active = active || customSplashClass.isInstance(TextRenderer);
